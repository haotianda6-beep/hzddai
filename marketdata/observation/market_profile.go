...
var marketProfiles = []MarketProfile{
	...
	{3, "弧光趋势", "捕捉多品种趋势机会，以纪律化规则控制波动。", "顾川", "https://api.dicebear.com/7.x/avataaars/svg?seed=gu-chuan-balib", 500},
	{4, "星轨资产", "基于跨品种轮动与分散配置管理组合风险。", "沈星河", "https://api.dicebear.com/7.x/avataaars/svg?seed=shen-xinghe-balib", 600},
	{5, "峻峰资本", "聚焦强势行情与风险收益比，追求稳健复利。", "江峻", "https://api.dicebear.com/7.x/avataaars/svg?seed=jiang-jun-balib", 600},
	{6, "脉冲矩阵", "以高响应信号捕捉短周期机会并动态管理敞口。", "陆遥", "https://api.dicebear.com/7.x/avataaars/svg?seed=lu-yao-balib", 600},
}
