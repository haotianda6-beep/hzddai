// COMKUN-AI i18n — Translation Keys
...
export const coinSource = {
  ...
  nofxosNote: { zh: '使用 COMKUN 数据 API Key（在指标配置中设置）', en: 'Uses COMKUN data API Key (set in Indicators config)', es: 'Usa API Key de datos COMKUN' },
...
export const indicator = {
  ...
  nofxosTitle: { zh: 'COMKUN 量化数据源', en: 'COMKUN Data Provider', es: 'Proveedor COMKUN' },
  ...
  nofxosDataSources: { zh: 'COMKUN 数据源', en: 'COMKUN Data Sources', es: 'Fuentes COMKUN' },
