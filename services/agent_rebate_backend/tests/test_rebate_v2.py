...
from app.models import Base, PartnerRole, User
from app.partner import assign_role, request_studio, request_withdrawal, review_withdrawal
...
class RebateV2Test(unittest.TestCase):
    ...
    def test_withdrawal_freeze_approve_paid(self):
        ...
        row = request_withdrawal(self.db, ib, Decimal("100"), "T" * 34)
        self.assertEqual(Decimal(ib.rebate_balance_usdt), Decimal("20"))
