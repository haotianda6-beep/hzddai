...
func BuildAgentPrompt(apiDocs, userEmail, userID string) string {
	return fmt.Sprintf(`You are the COMKUN-AI quantitative trading system AI assistant.
